...
//    List<RestaurantEntity> findRestaurants( String type, String city, String country, String name);
    ...
    @Query("SELECT r FROM RestaurantEntity r " +
            ...
            "WHERE (:username IS NULL OR (u.username = :username AND u.address.country = a.country)) " +
    ...
    @Query("SELECT DISTINCT r.type, r.address.country, r.address.city FROM RestaurantEntity r")
    List<Object[]> findDistinctCountriesAndCitiesByType();
